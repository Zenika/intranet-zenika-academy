...
module.exports = {
    getAllPromotion: (req, res) => {
        return Promotions.findAll({ raw: true })
            .then(content => res.send(content))
            .catch(e => res.status(400).send(e));
    },

    getPromotionById: (req, res, next) => {
        return Promotions.findOne({ where: { id:  res.locals["promotion_id"] } })
    ...
    promotionDelete: (req, res) => {
        return Promotions.destroy({ where: { id: res.locals["promotion_id"] } })
